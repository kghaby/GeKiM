...
def kobs_uplim_fit_to_occ_final_wrt_t(t: np.array, occ_final: np.array, nondefault_params: dict = None, xlim=None): 
    '''
...
def kobs_KI_uplim_fit_to_occ_total_wrt_t(t: np.array, occ_tot: np.array, nondefault_params: dict = None, xlim=None): 
    '''
...
def KI_kinact_n_fit_to_kobs_wrt_concI0(concI0: np.array, kobs: np.array, nondefault_params: dict = None, xlim=None):
    """
